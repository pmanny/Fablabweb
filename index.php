...
<head>
		...
		<link rel="icon" href="assets/img/fablab-favicon.png">

		<title>Fablab Rwanda</title>
	</head>
	<body>
				...
				<div class="modal-content">
					<div class="modal-body">
						...
						<div class="text-center">
							<img src="assets/img/fablab-logo-wide.png" alt="Fablab Rwanda logo" class="img-fluid mb-3" style="width: 200px;">
						</div>
								...
								<div class="list-group list-group-flush">
									...
									<a class="list-group-item" href="docs/alerts.html">
										...
										<div class="ml-4">
											...
											<!-- Text -->
											<p class="font-size-sm text-gray-700 mb-0">
												Creating appealing and useful furniture
											</p>
									...
									<a class="list-group-item" href="docs/changelog.html">
										...
										<div class="ml-4">
											...
											<!-- Text -->
											<p class="font-size-sm text-gray-700 mb-0">
												Various tools for rapid electronics and manufacturing prototyping
											</p>
				...
				<div class="row align-items-center">
					...
					<div class="col-12 col-md-7 col-lg-6 order-md-1" data-aos="fade-up">
						...
						<h1 class="display-4 text-center text-md-left">
							Welcome to <span class="text-primary">Fablab Rwanda</span>.						
						</h1>
						<h2 lass="display-5 text-center text-md-left">Make almost anything.</h2>

						<!-- Text -->
						<p class="lead text-center text-md-left text-muted mb-6 mb-lg-8">
							A colloborative community and creative research lab leading the electronics and manufacturing.
						</p>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-12 col-md-6" data-aos="fade-up" data-aos-delay="50">
						...
						<!-- Text -->
						<p class="text-muted mb-6 mb-md-0">
							The Lab is open to all currently enrolled students and staff of the Faculty and our professional members. We welcome individuals, organisations willing to bring their ideas to reality using our additive manufacturing machines, CNC tools and community.
						</p>
				...
				<div class="row justify-content-center">
					<div class="col-12 col-md-10 col-lg-8 text-center">
						...
						<p class="lead text-gray-700">
							Fablab Rwanda features complex equipments that were assembled in some of the world renowned industries for its members and the public which allows them expressing their ideas
						</p>
									...
									<div class="col-12 col-xl-9">
										...
										<div class="text-center mb-5">
											<span class="badge badge-pill badge-primary-soft">
												<span class="h6 font-weight-bold text-uppercase">3D Printing</span>
											</span>
										</div>
										...
										<div class="d-flex justify-content-center">
											...
											<span class="price display-2 mb-0" data-annual="29" data-monthly="49">20</span>
											<span class="h2 align-self-end mb-1">/kg</span>
										</div>
										...
										<div>
											<img src="assets/img/devices/3d-printer-1.jpg" class="img-fluid img-skewed-item" />
										</div>
								...
								<div class="row justify-content-center">
									<div class="col-12 col-xl-10">
										...
										<p class="text-center mb-8 mb-md-11">
											<span class="badge badge-pill badge-primary-soft">
												<span class="h6 font-weight-bold text-uppercase">Cutting & Engraving</span>
											</span>
										</p>

										<div>
											<img src="assets/img/devices/shopbot.jpg" class="img-fluid img-skewed-item" />
										</div>
				...
				<div class="row justify-content-center">
					<div class="col-12 col-md-10 col-lg-8 text-center">
						...
						<h1 class="display-4 text-white">
							Check our works and get yours.
						</h1>

						<!-- Text -->
						<p class="font-size-lg text-muted mb-6 mb-md-8">
							Go through our works and ask us to make you what you prefer.
						</p>

						<!-- Button -->
						<a href="/" target="_blank" class="btn btn-success lift">
							Check now <i class="fe fe-arrow-right"></i>
						</a>
		...
		<section class="py-6 py-md-8 border-bottom">
			<div class="container">
				<div class="row align-items-center justify-content-center">
					<div class="col-12">
						<h2 lass="display-5 text-center text-md-left">Our partners</h2>
					</div>
					<div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0">
						<div class="img-fluid text-gray-600 mb-2 mb-md-0">
							<img src="assets/img/partners/JICA.png" class="img-fluid img-skewed-item partner-img" alt="JICA's FabLab partner" />
						</div>
					</div>
					<div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0">
						<div class="img-fluid text-gray-600 mb-2 mb-md-0">
							<img src="assets/img/partners/gasabo 3d logo.png" class="img-fluid img-skewed-item partner-img" alt="JICA's FabLab partner" />
						</div>
					</div>
					<div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0">
						<div class="img-fluid text-gray-600 mb-2 mb-md-0">
							<img src="assets/img/partners/rura.jpg" class="img-fluid img-skewed-item partner-img" alt="JICA's FabLab partner" />
						</div>
					</div>
					<div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0">
						<div class="img-fluid text-gray-600 mb-2 mb-md-0">
							<img src="assets/img/partners/mineduc.jpg" class="img-fluid img-skewed-item partner-img" alt="JICA's FabLab partner" />
						</div>
					</div>
					<div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0">
						<div class="img-fluid text-gray-600 mb-2 mb-md-0">
							<img src="assets/img/partners/solidworks.png" class="img-fluid img-skewed-item partner-img" alt="JICA's FabLab partner" />
						</div>
					</div>
					<div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0">
						<div class="img-fluid text-gray-600 mb-2 mb-md-0">
							<img src="assets/img/partners/klab.png" class="img-fluid img-skewed-item partner-img" alt="JICA's FabLab partner" />
						</div>
					</div>
					<div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0">
						<div class="img-fluid text-gray-600 mb-2 mb-md-0">
							<img src="assets/img/partners/cba.jpg" class="img-fluid img-skewed-item partner-img" alt="JICA's FabLab partner" />
						</div>
					</div>
					<div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0">
						<div class="img-fluid text-gray-600 mb-2 mb-md-0">
							<img src="assets/img/partners/ict-chamber.jpg" class="img-fluid img-skewed-item partner-img" alt="JICA's FabLab partner" />
						</div>
					</div>
					<div class="col-6 col-sm-4 col-md-2 mb-2 mb-md-0">
						<div class="img-fluid text-gray-600 mb-2 mb-md-0">
							<img src="assets/img/partners/rdb.jpg" class="img-fluid img-skewed-item partner-img" alt="JICA's FabLab partner" />
						</div>
					</div>
				</div> <!-- / .row -->
			</div> <!-- / .container -->
					...
					<div class="col-12 col-md-4 col-lg-4">
						...
						<ul class="list-unstyled list-inline list-social mb-6 mb-md-0">
							<li class="list-inline-item list-social-item mr-3">
								<a href="https://www.instagram.com/fablabrwand/" class="text-decoration-none">
									<img src="assets/img/icons/social/instagram.svg" class="list-social-icon" alt="...">
								</a>
							</li>
							<li class="list-inline-item list-social-item mr-3">
								<a href="https://www.facebook.com/KigaliFabLab/" class="text-decoration-none">
									<img src="assets/img/icons/social/facebook.svg" class="list-social-icon" alt="...">
								</a>
							</li>
							<li class="list-inline-item list-social-item mr-3">
								<a href="https://twitter.com/fablabrw" class="text-decoration-none">
